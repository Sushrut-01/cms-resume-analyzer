...
DATA PRIVACY & COMPLIANCE ASSESSMENT REPORT  VERSION 3
Document Ref: K-RECRUIT-COMP-2026-003

COMPLETE document — fully supersedes v1 (CMS-TalentAI-COMP-2026-001)
                                    and v2 (CMS-TalentAI-COMP-2026-002).

All sections from v1 and v2 are included and updated.
New in v3:
  - Project renamed: CMS TalentAI → K Recruit
  - HuggingFace model exact details (what, where cached, offline path)
  - Azure subscription setup guide with cost estimate
  - Full SSL/HTTPS guide for localhost → LAN production (4 options + nginx config)
  - SQLite/PostgreSQL license & certificate clarification
...
cl("VERSION 3 — COMPLETE EDITION  (Supersedes v1 and v2)",         9, GRAY_L,  bold=True,  after=16)

for lbl, val in [
    ("Document Ref:",    "K-RECRUIT-COMP-2026-003"),
    ("Version:",         "3.0 — Final  |  Supersedes v1 (2026-001) and v2 (2026-002)"),
    ("Prepared for:",    "Kforce US Compliance / IT Governance Team"),
    ("Prepared by:",     "Application Compliance Review — Technical Architecture"),
    ("Scope:",           "Complete compliance assessment — data flows, libraries, SSL, Azure, SQLite, HuggingFace"),
...
body("Version 3 additionally documents and resolves three questions raised by the compliance team:")
for item in [
